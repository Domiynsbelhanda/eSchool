...
<body>
	...
	<header id="head" class="secondary">
		...
		<div class="container-fluid" style="margin-top:10px;margin-left:82px;margin-right:450px;">
			<h1><?php echo $title; ?></h1><br><label><?php echo $dinfo; ?></label><button onclick="location.href='../course/chapter.php'" class="btn btn-block">
			Commencer le cours >>
		</button>
		</div>
		<div class="container-fluid" style="margin-left:82px;margin-right:450px;">
			...
			<button onclick="location.href='purchase.php'" class="btn btn-block">Acheter maintenant >></button><br>
			<button onclick="location.href='../download/index.php'" class="btn btn-block">Telecharger  nos E-Books gratuitements</button><br>
		</div>
	<?php
		include "footer.php";
	?>
