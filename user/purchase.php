...
<body>
	...
	<form method="POST" action="">
		<table border=0 align="center">
			<tr>
				<td><label>Selectionner un livre:</label></td>
		...
		<br>
		<button name="submit" class="btn btn-block">Acheter maintenant >></button>
	</form>
	</div>
	</div>
	</div>
	<?php
		if(isset($_POST['submit']))
		{
			...
			if($result)
			{
				echo "<div class='alert alert-success' role='alert'>Achat effectuée</div>";
			}
			else
			{
