...
<body>
	...
	<br>
	<?php
		$query = "SELECT * FROM expert_info WHERE UserName='$username'";
	...
	<form method="POST" action="#">
		<table border=0 align="center">
			<tr>
				<td><label>Mettre à jour le nom :</label></td>
				<td><input type="text" class="form-control" name="fname" value="<?php echo $fname;?>"></td>
			</tr>
			<tr>
				<td><label>Mettre à jour le postnom :</label></td>
				<td><input type="text" class="form-control" name="mname" value="<?php echo $mname;?>"></td>
			</tr>
			<tr>
				<td><label>Mettre à jour le prénom :</label></td>
				<td><input type="text" class="form-control" name="lname" value="<?php echo $lname;?>"></td>
			</tr>
			<div class="checkbox">
				<tr>
					<td><label>Genre :</label></td>
					<td><input type="radio" name="gender" value="male" <?php if($gender=="male"){ echo "checked";}?>>Homme &nbsp; <input type="radio" name="gender" value="female" <?php if($gender=="female"){ echo "checked";}?>>Femme</td>
				</tr>
			</div>
			<tr>
			...
			<tr>
				<td><label>Mettre à jour votre mot de passe :</label></td>
				<td><input type="password" class="form-control" name="pass" value="<?php echo $password;?>"></td>
			</tr>
			<tr>
				<td colspan="2" align="center"><button class="btn btn-block"name="btn">Mettre à jour</button></td>
			</tr>
		</table>
	</form>
	<?php
	if(!empty($_POST['fname'])&&!empty($_POST['lname']))
	{
		...
		if($result)
		{
			echo "<div class='alert alert-success' role='alert'>Mise à jour effectuée avec succès.</div>";
